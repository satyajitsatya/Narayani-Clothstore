...
pcard.forEach((value)=>{
    value.addEventListener("click",()=>{
        ...
        let fabric = value.childNodes[17].innerText;
        let pattern = value.childNodes[19].innerText;
        let sleeve = value.childNodes[21].innerText;
       ...
       psleeve.innerText = sleeve;
        ...
        console.log(imgsrc1,imgsrc2,imgsrc3,asize,color,type,fabric,sleeve)
    })
})
